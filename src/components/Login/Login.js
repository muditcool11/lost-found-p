...
import { userexists, userloginfunc } from "../../services/ItemService";
  ...
  async function userlogin(e) {
    ...
    try {
      ...
      if (loginResponse.data === "Login Successful") {
        ...
        const userExistsResponse = await userexists(LoginData.email);
        //console.log(userExistsResponse.data);
        // let id= res.data.id;
        
        useremail = userExistsResponse.data.email;
        userid = userExistsResponse.data.id;
        username = userExistsResponse.data.fullname;
